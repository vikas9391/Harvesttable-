...
const SignupPage: React.FC = () => {
  ...
  const [legalModal, setLegalModal] = useState<ModalDoc>(null)
      ...
      <div className="min-h-screen flex" style={{ backgroundColor: C.bg, fontFamily: "'Jost', sans-serif", direction: isRTL ? 'rtl' : 'ltr' }}>
        ...
        >
          ...
          <div style={{ borderRadius:16, padding:20, backgroundColor:'rgba(255,255,255,0.05)', border:'1px solid rgba(212,160,96,0.14)', animation:'panelSlide 0.7s ease 1.1s both' }}>
            ...
            <p style={{ fontSize:13, fontStyle:'italic', lineHeight:1.7, marginBottom:12, color:'rgba(212,160,96,0.8)' }}>{t('signup.quote')}</p>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 pt-28 lg:pt-24 overflow-y-auto">
          <div className="w-full max-w-[420px]">
              ...
              <div style={fade(0.25)}>
                ...
                <div style={{ position:'relative' }}>
                  <input
                    ...
                    onBlur={e => e.currentTarget.style.borderColor = C.border}
                  />
                  <button type="button" onClick={() => setShowPw(v => !v)} style={{ position:'absolute', [isRTL?'left':'right']:12, top:'50%', transform:'translateY(-50%)', background:'none', border:'none', cursor:'pointer', color:C.muted, padding:4 }}>
                    <EyeIcon open={showPw}/>
                  </button>
                </div>
              ...
              >
                ...
                <span style={{ fontSize:13, lineHeight:1.6, color:C.muted }}>
                  ...
                  <button
                    ...
                    style={{ color:C.accent, fontWeight:600, background:'none', border:'none', cursor:'pointer', padding:0, fontSize:13, fontFamily:'inherit', textDecoration:'underline' }}
                  >
                    {t('signup.terms')}
                  </button>
                  {' '}{t('signup.and')}{' '}
            ...
            <div style={{ ...fade(0.45), display:'flex', alignItems:'center', justifyContent:'center', gap:6, marginTop:20 }}>
              ...
              <p style={{ fontSize:11, textAlign:'center', color:C.muted, margin:0 }}>{t('signup.dataNote')}</p>
            </div>
